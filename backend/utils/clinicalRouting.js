...
const RULES = [
  {
    department: DEPARTMENTS.banco_de_sangue,
    diagnoses: [
  ...
  {
    department: DEPARTMENTS.estomatologia,
    diagnoses: [
  ...
  {
    department: DEPARTMENTS.dermatologia,
    diagnoses: [
  ...
  {
    department: DEPARTMENTS.consulta_externa,
    diagnoses: [
  ...
  {
    department: DEPARTMENTS.laboratorio_principal,
    diagnoses: [
...
function deriveVitalAlerts({ temperatura, saturacaoOxigenio, frequenciaCardiaca, frequenciaRespiratoria, nivelDor, estadoGeral }) {
  ...
  if (normalizeText(estadoGeral) === 'critico' || normalizeText(estadoGeral) === 'crítico') {
    alerts.push('estado geral crítico');
    priorities.push('muito_alta');
  } else if (normalizeText(estadoGeral) === 'debilitado') {
...
function getClinicalRouting(payload = {}) {
  const sintomas = payload.sintomas || '';
